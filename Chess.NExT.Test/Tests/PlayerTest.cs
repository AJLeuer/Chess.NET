    ...
    public static class PlayerTest
    {
        ...
        public static void ShouldFindOwnPiecesOnBoard()
        {
            ...
            var squares = new Square[,]
            {
                ...
                { new Square('♝', 'f', 8), new Square(' ', 'f', 7), new Square(' ', 'f', 6), new Square(' ', 'f', 5), new Square(' ', 'f', 4), new Square(' ', 'f', 3), new Square(pawnF2, 'f', 2), new Square(' ', 'f', 1) },
			
                { new Square(' ', 'g', 8), new Square('♟', 'g', 7), new Square(' ', 'g', 6), new Square(' ', 'g', 5), new Square(' ', 'g', 4), new Square(' ', 'g', 3), new Square(pawnG2, 'g', 2), new Square(knightG1, 'g', 1) },
